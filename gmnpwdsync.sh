...
rsyncrunning=$(ps -x | grep rsync | grep $1 | wc -l)
...
nohup rsync --password-file=/home/$1/.passfile  -avzh  --partial-dir=.partial ~/RMS_data/ArchivedFiles/*.bz2 rsync://$1@rvrgm.asuscomm.com:12000/$1 &
