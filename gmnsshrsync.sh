...
nohup rsync -a -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null"   --partial-dir=partial/ ~/RMS_data/ArchivedFiles/*.bz2 au000u@192.168.1.230:files/incoming &
